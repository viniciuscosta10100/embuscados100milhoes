...
plot(linebubble[,1],linebubble[,3],type="l",main="Gráfico de curva - Bubblesort",xlab="Elementos no array",ylab="Trocas",col="red")
lines(linebubble[,1],linebubble[,4],col="green",type="l")
legend("topleft",c("Decrescente","Aleatório"),col=c("red","green"),lty=1,lwd=2,bty="n")
plot(lineheap[,1],lineheap[,2],type="l",main="Gráfico de curva - Heapsort",xlab="Elementos no array",ylab="Trocas",col="blue")
...
plot(linebubble[,1],linebubble[,4],type="l",main="BUBBLESORT VS HEAPSORT - ALEATÓRIO",xlab="Elementos no array",ylab="Trocas",col="blue")
lines(lineheap[,1],lineheap[,4],col="green",type="l")
